      ...
      <div class="main">
        <div class="left" style="margin:0px 0 0 0;">
          <div class="section">
            ...
            <div class="sectThree" id="mars"><p>The Mars Rover team has competed in the University Rover Challenge since 2008, when they took first place. The teleoperated rover must perform a variety of tasks, including locating bacteria, locating a distressed astronaut, and manipulating a control panel. </p><a href="<?php echo esc_url( home_url( '/' ) ); ?>/mars">Visit here for more</a>.</div>
