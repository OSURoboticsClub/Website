      ...
      <div class="main">
        <div class="left" style="margin:0px 0 0 0;">
          <div class="section">
            ...
            <div class="sectThree" id="aerial"><p>The Autonomous Aerial team was formed in 2009 and competes in the International Aerial Robotics Competition. For the 2013 competition, the vehicle must navigate through a building, remove a flash drive from a table, and replace it with a new one. </p><a href="http://groups.engr.oregonstate.edu/osurc/aerial/">Visit here for more</a>.</div>
            <div class="sectThree" id="mars"><p>The Mars Rover team has competed in the University Rover Challenge since 2008, when they took first place. The teleoperated rover must perform a variety of tasks, including locating bacteria, locating a distressed astronaut, and manipulating a control panel. </p><a href="http://www.osumarsrover.com">Visit here for more</a>.</div>
